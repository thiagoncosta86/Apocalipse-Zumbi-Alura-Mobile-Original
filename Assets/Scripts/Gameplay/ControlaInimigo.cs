...
public class ControlaInimigo : MonoBehaviour, IMatavel, IReservavel
{
    ...
    private void Awake()
    {
        ...
        pontuavel = GetComponent<Pontuavel>();
    }
    ...
    void FixedUpdate()
    {
        ...
        MovimentaZumbiPelaDistanciaDoJogador(distancia);
    }

    private void MovimentaZumbiPelaDistanciaDoJogador(float distancia)
    {
        if (distancia > 15)
        {
            Vagar();
